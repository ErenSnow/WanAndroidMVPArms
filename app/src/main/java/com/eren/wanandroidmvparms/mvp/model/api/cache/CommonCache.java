 ...
 */
package com.eren.wanandroidmvparms.mvp.model.api.cache;
...
public interface CommonCache {
    ...
    Observable<Reply<BaseResponse<HomeArticleBean>>> getHomeArticle(Observable<BaseResponse<HomeArticleBean>> users, DynamicKey idLastUserQueried, EvictProvider evictProvider);
}
